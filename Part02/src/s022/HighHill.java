...
public class HighHill {
	public static void main(String[] args) {
		...
		System.out.println("=== S022");
		System.out.printf("적당한 하이힐 높이는 %1$.2f cm입니다.", high);
		// %1$는 첫번째 변수 high를 1$ 위치에 대입하라는 의미. %f는 실수, %.2f는 소수점 두 자리까지 표시한다는 의미함.
	}
}
