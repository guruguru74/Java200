package s090_빌보드차트웹사이트에서_정보를읽어_리스트에저장하기;
...
public class BillboardArrayMain {
	private static String title = "=> s090_빌보드차트웹사이트에서_정보를읽어_리스트에저장하기";
	public static void main(String[] args) {
		...
		try {
			// 주소지에 빨대 꽂기
			BufferedReader reader = new BufferedReader(new FileReader(fnames));
			String line = null;
